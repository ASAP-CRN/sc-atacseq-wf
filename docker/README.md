...
- _Counts to AnnData_: [`counts_to_adata`](./sc_atac_tools/counts_to_adata)
...
- _Merge and QC_: [`merge_and_qc`](./sc_atac_tools/merge_and_qc)
...
- _Process bins_: [`process_bins`](./sc_atac_tools/process_bins)
...
- _Run harmony_: [`run_harmony`](./sc_atac_tools/run_harmony)
...
- _Harmony clustering_: [`cluster_harmony`](./sc_atac_tools/cluster_harmony)
...
- _Benchmark integration_: [`benchmark_sc_integration`](./scvi_tools/benchmark_sc_integration)
...
- _Generate gene matrix_: [`generate_gene_matrix`](./sc_atac_tools/generate_gene_matrix)
...
- _Process genes_: [`process_genes`](./sc_atac_tools/process_genes)
...
- _Impute gene matrix_: [`impute_gene_matrix`](./sc_atac_tools/impute_gene_matrix)
...
- _Motif enrichment analysis_: [`motif_enrichment`](./sc_atac_tools/motif_enrichment)
...
- _Plot groups and features_: [`plot_groups_and_feats`](https://github.com/ASAP-CRN/sc-rnaseq-wf/tree/main/docker/sc_tools/scripts/main/plot_groups_and_feats)
    - Shared script from [`sc-rnaseq-wf`](https://github.com/ASAP-CRN/sc-rnaseq-wf)
...
- _Export final artifacts_: [`export_final_artifacts`](./sc_atac_tools/export_final_artifacts)
